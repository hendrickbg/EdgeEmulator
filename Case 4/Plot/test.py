...
def plot_data(directory_type, file_name):
    ...
    fig, axs = plt.subplots(num_rows, num_cols, figsize=(15 * num_cols-10, 6 * num_rows), sharex=True)
    ...
    for i, directory in enumerate(directories):
        ...
        print("[{}]Total average: {}".format(cont, total_avarege))
        ...
        # ax1.bar(x_values, averages, color='blue', width=0.8)
        ...
        # print("Total average: ", np.mean(averages), averages)
    ...
    # Save plot as PNG
    plt.savefig(f'{directory_type}3.png'.lower(), bbox_inches='tight')
